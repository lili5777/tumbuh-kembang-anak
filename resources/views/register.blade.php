...
<head>
    ...
    <title>Daftar - Aplikasi Tumbuh Kembang Anak</title>
...
<body>
    ...
    <div class="register-container">
        ...
        <p class="subtitle">Bergabung untuk memantau tumbuh kembang anak Anda</p>

        @if($errors->any())
            <div class="alert alert-danger"
                style="color: red; background-color: #ffeeee; padding: 8px; border-radius: 5px; margin-bottom: 15px; border: 1px solid #ffcccc;">
        ...
        @if(session('success'))
            <div class="alert alert-success"
                style="color: green; background-color: #eeffee; padding: 8px; border-radius: 5px; margin-bottom: 15px; border: 1px solid #ccffcc;">
                {{ session('success') }}
            </div>
        @endif
        ...
        <p class="login-link">Sudah punya akun? <a href="{{ route('login') }}">Masuk disini</a></p>
    </div>
</body>
