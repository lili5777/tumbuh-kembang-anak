                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="d-none d-md-flex justify-content-center gap-3">
                                            <a href="{{ route('generate.report') }}" class="btn btn-primary">
                                                <i class="fas fa-download me-2"></i>Download Proses KNN
                                            </a>
                                            <a href="{{ route('hasil.report') }}" class="btn btn-primary">
                                                <i class="fas fa-download me-2"></i>Download Hasil KNN
                                            </a>
                                        </div>
                                        ...
                                        <div class="d-md-none">
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <a href="{{ route('generate.report') }}" class="btn btn-primary w-100">
                                                        <i class="fas fa-download me-2"></i>Download Proses KNN
                                                    </a>
                                                </div>
                                                <div class="col-12">
