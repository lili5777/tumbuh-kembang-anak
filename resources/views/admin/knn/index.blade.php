                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#viewChildModal-${anak.id}">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteChildModal-${anak.id}" data-id="${anak.id}">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    </div>
                                </td>
